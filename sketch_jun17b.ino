...
const char ssid[] = "Guata";
//Contraseña de la red Wifi
const char pass[] = "Piliysandra";

//Pines para medir luminosidad
const int led_azul = 2; //PIN D4
const float luminosidad = A0; //Analógico A0


//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "j.guataquira"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "j.guataquira";
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = "200812351";
...
void setup()
{
  ...
  pinMode (luminosidad, INPUT); //Mide entrada sensor
  pinMode (led_azul, OUTPUT); //Actuador para verificar funcionamiento
...
void loop()
{
  ...
  float lum = analogRead(luminosidad);
  ...
  //Condicionales para validar funcionamiento de sensor de luminosidad

  if (lum <= 600)
  {
    //Si hay poca luz
    Serial.print("Hay poca luz, encender led Azul");
